...
namespace Color
{
	...
	{
	public:
		WindowsMessageDialog(std::string_view caption, std::string_view content, DialogControls controls = DialogControls::Ok, DialogIcon icon = DialogIcon::None);
		virtual ~WindowsMessageDialog() override = default;
